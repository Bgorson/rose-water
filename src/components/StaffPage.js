...
`,
  ...
  },
  {
    ...
    header: 'Talia Farrell-Rosen, LCSW',
    blurb: `I'm Talia Farrell-Rosen, a Licensed Clinical Social Worker with my MSW from Boston College, specializing in DBT to support adolescents, families, and adults managing emotion dysregulation, mood disorders, ADHD, autism, and anxiety.`,
    title: 'Licensed Clinical Social Worker',
    image: Talia,
    specialties: ['DBT', 'ADHD', 'Autism', 'Adolescents', 'Anxiety'],
    description1: `Talia is a Licensed Clinical Social Worker and a graduate of Boston College's Master of Social Work program, bringing extensive experience from her previous roles in school and behavioral health settings, where she supported children and teens from diverse backgrounds. At Rosewatter, she provides therapy for both adults and adolescents.`,
  ...
  },
  {
    id: 13,
    routeName: 'julia',
    header: 'Julia Friedland, LCSW',
    email: 'jfriedland@rosewatterchicounseling.com',
    blurb: `I'm Julia Friedland, a Licensed Clinical Social Worker with a Master's from Columbia University's School of Social Work. I specialize in supporting both adolescents and adults managing symptoms of depression, anxiety, emotion dysregulation, and mood disorders.`,
    title: 'Licensed Clinical Social Worker',
    image: Julia,
    specialties: [
      'DBT',
